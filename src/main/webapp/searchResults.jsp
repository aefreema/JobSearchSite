...
<html>
    <head>
        ...
        <link href="styles/resultsPage.css" rel="stylesheet" type="text/css" />
        ...
        <div id="container">
            <div id="resultsPage">
                ...
                <div id="listResults"> <%-- use angular or for each statement, only write once --%>
                    <table>
                        <tr>
                            <td><a href="JobServlet" class="jobTitle">Software Engineer</a></td>
                            <td><span class="jobLocation">Pleasanton, CA</span></td>
                        </tr>
                        <tr>
                            <td><a href="JobServlet" class="jobTitle">Accountant</a></td>
